...
#define ST25R_SS_PIN             NFC_SPI_SS_Pin    /*!< GPIO pin used for ST25R SPI SS                */
#define ST25R_SS_PORT            NFC_SPI_SS_GPIO_Port   /*!< GPIO port used for ST25R SPI SS port          */

#define ST25R_INT_PIN            ST25R_INT_Pin    /*!< GPIO pin used for ST25R IRQ                   */
#define ST25R_INT_PORT           ST25R_INT_GPIO_Port   /*!< GPIO port used for ST25R IRQ port             */

#define IRQ_ST25R_EXTI_IRQn      EXTI0_IRQn

#define PLATFORM_LED_FIELD_PIN       LED6_Pin         /*!< GPIO pin used as field LED                        */

#define PLATFORM_LED_FIELD_PORT      LED6_GPIO_Port    /*!< GPIO port used as field LED                       */

#define PLATFORM_LED_A_PIN           LED3_Pin         /*!< GPIO pin used for LED A    */
#define PLATFORM_LED_A_PORT          LED3_GPIO_Port    /*!< GPIO port used for LED A   */
...
#define PLATFORM_LED_F_PORT          LED1_GPIO_Port    /*!< GPIO port used for LED F   */
